...
- Global suspension completion now reflects actual sandbox and RBAC teardown rather than only terminal run conditions.
...
- Operator tests must cover condition mapping, precedence, phase races, zero-grace deletion, both sandbox modes, orphan discovery, terminal cleanup retries, late resources/results, and suspension Draining completion.
